	...
	this.updateVal = function(data)
	{
		...
		for (var j in data.d)
		{
			if (typeof data.d[j] !== 'string') {
				if(j == 'temp'){
					document.getElementById('temp_val').innerHTML = data.d[j];
				}else if(j == 'accelX'){
					document.getElementById('accelX_val').innerHTML = data.d[j];
				}else if(j == 'accelY'){
					document.getElementById('accelY_val').innerHTML = data.d[j];
				}else if(j == 'accelZ'){
					document.getElementById('accelZ_val').innerHTML = data.d[j];
				}
			}
		}
